              ...
              child: Column(
                ...
                children: [
                          ...
                          child: Container(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: "https://image.tmdb.org/t/p/original/" +
                                  SeriesDetails['backdrop_path'].toString(),
                              fit: BoxFit.fill,
                        ...
                        Positioned(
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.only(top: 90.0, left: 20),
                                child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        SeriesDetails['genres'][index]['name'],
                                        style: TextStyle(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: ListView.builder(
                                    scrollDirection: Axis.horizontal,
                                    itemCount: SeriesDetails['spoken_languages']
                                        .length,
                                    itemBuilder: (context, index) => Padding(
                      ...
                      itemBuilder: (context, index) => Padding(
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              onTap: () => setState(() {
                                seasonNumber = Seasons[index]['season_number'];
                      ...
                      ? Container(
                          child: Column(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(
                                    left: 10.0, right: 10, bottom: 00, top: 10),
                                child: Text(
                                    videos.length != 0
                                        ? 'Videos'
                                        : 'No Videos Available',
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) => GestureDetector(onTap: () => Navigator.push(
                                        context,
                                        MaterialPageRoute(
                  ...
                  SeriesDetails['networks'].length != 0
                      ...
                      : Container(),
                   SimilarSeries.length != 0 ? Container(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Padding(
                          ...
                          child: Text(
                              SimilarSeries.length != 0 ? 'Similar Series' : '',
                              style: TextStyle(
                                  fontSize: 18,
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold)),
