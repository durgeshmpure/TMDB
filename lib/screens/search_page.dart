  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: Column(children: [
                        ...
                        children: [
                          Padding(
                            ...
                            child: ClipRRect(
                              ...
                              child: Container(
                                width: 100,
                                child: search[index]['media_type'].toString() ==
                                        'movie' ||search[index]['media_type'].toString() ==
                                        'tv'
                                    ? CachedNetworkImage(
                                        imageUrl:
                            ...
                            child: Container(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      search[index]['media_type'].toString() !=
                                              'tv'
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        bottom: 8.0, top: 8),
                                    child: Text(
                                      search[index]['media_type'] != 'person'
                                          ? search[index]['original_language']
                                              .toString()
                                              .toUpperCase()
                                          : search[index]['gender']
                                                      .toString() ==
        ...
        ):Text(message,style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),)
      ]),
    ));
  }
}
