...
class _DesctestState extends State<Desctest> {
  Map MovieDetails = {'name': 'Tom', 'age': '23'};
  List Moviecredits = [];
  List SimilarMovies = [];
  List videos = [];
  ...
  loadMovies() async {
    ...
    Map certificationResults = await tmdbWithCustomLogs.v3.movies.getReleaseDates(widget.movieId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MovieDetails['spoken_languages'] == null
